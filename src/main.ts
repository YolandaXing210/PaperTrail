...
const planeGltfLoader = new GLTFLoader();
// paper_plane.glb is now Draco-compressed, so this loader needs a Draco decoder too.
const planeDracoLoader = new DRACOLoader();
planeDracoLoader.setDecoderPath("/draco/");
planeGltfLoader.setDRACOLoader(planeDracoLoader);
planeGltfLoader.load(
